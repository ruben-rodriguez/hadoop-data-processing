        ...
        if (key.get() > 0) {
            ...
            try {
                ...
                if(!row[5].isEmpty()) {
                    ...
                    context.write(new Text(weekDayFormat), new IntWritable(1));
                    context.write(new Text(timeFormat), new IntWritable(1));
                    context.write(new Text(combinedFormat), new IntWritable(1));
